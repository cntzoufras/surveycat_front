  ...
  return (
    <Col md={12} lg={12} xl={6}>
      <Card>
        <CardBody>
          <CardTitleWrap>
            <CardTitle>{t('forms.check_form_controls.colored_controls')}</CardTitle>
            <CardSubhead>Checkboxes and radio buttons. Use prop
              <span className="red-text"> styleType</span> with <span className="red-text">colored</span> value
            </CardSubhead>
          </CardTitleWrap>
          <Form onSubmit={onSubmit}>
            {({ handleSubmit }) => (
              <FormContainer preview onSubmit={handleSubmit}>
                ...
                <CheckBoxGroup name="button" styleType="colored" />
                <RadioButtonsGroup styleType="colored" />
              </FormContainer>
            )}
          </Form>
        </CardBody>

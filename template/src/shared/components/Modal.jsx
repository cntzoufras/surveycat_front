...
import {
  colorAccent, colorBlue, colorWhite, colorYellow, colorRed,
  colorIcon, colorBackground, colorText,
} from '@/utils/palette';
import {
 flexFlow, paddingRight, paddingLeft, right, left,
    ...
    <div>
      ...
      >
        ...
        <ModalFooter>
          ...
          <Button variant={buttonVariant} onClick={toggle}>Ok</Button>
        </ModalFooter>
      </StyledModal>
    </div>
  );

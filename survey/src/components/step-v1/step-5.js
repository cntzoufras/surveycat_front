...
class StepFive extends React.Component {
  ...
  componentDidMount() {
    ...
    const requestOptions = {
      ...
      body: JSON.stringify({ body: "this is some body", title: "this title" }),
    };
    fetch("http://localhost/api/posts/create", requestOptions)
        ...
        <div className="wizard-forms">
            ...
            <div className="form-content pera-content">
              <div className="step-inner-content">
                ...
                <div className="step-content-field">
                    ...
                    <div className="plan-icon-text text-center active">
                      ...
                      <div className="plan-text">
                        ...
                        <p>
                          ...
                          concludaturque usu, dicit viderer evertitur
                        </p>
                        <input
                          type="radio"
                          name="your_plan"
                  ...
                  <div className="budget-area">
                    ...
                    <div className="opti-list">
                      <ul className="d-md-flex">
                        ...
                        <li className="bg-white">
                          <input type="checkbox" name="code_opti3" value="Mobile Design" />
                          Mobile Design
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="card-body">Returned Post Body: {body}</div>
                  <div className="card-body">Returned Post Title: {title}</div>
                  <div
          ...
          <div className="actions">
            <ul>
              ...
              <li>
                <button type="submit" title="NEXT" onClick={this.handleSubmit}>
                  A SUBMIT PALIO KARIOLA <i className="fa fa-arrow-right"></i>
                </button>
              </li>
            </ul>
          </div>

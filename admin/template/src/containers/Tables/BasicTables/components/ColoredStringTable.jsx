  ...
  return (
    <Col md={12} lg={12} xl={6}>
      <Card>
        <CardBody>
          <CardTitleWrap>
            <CardTitle>{t('tables.basic_tables.colored_string_table')}</CardTitle>
            <CardSubhead>Use default table with property <span className="red-text">striped</span></CardSubhead>
          </CardTitleWrap>

  ...
  <Card height="auto">
    <CardBody>
      ...
      <p>The template uses <a href="https://github.com/ReactTraining/react-router">react-router</a> for navigation.
        Add a new Route in <b>src/app/Router.js</b> to add new navigation item:
      </p>
      <CodeHighlither>
        {'<Route path=\'/path_to_page\' component={Page}/>'}
      </CodeHighlither>
      <p>Then add new SidebarLink in <b>src/pages/_layout/sidebar/SidebarContent.js</b></p>
      <CodeHighlither>
        {`<SidebarLink title='Page' route='/path_to_page' onClick={this.hideSidebar}/>
//also you can add icon`}
      </CodeHighlither>
      <p>Or add TopbarNavLink in <b>src/pages/_layout/topbar_with_navigation/topbar_nav</b> and
        SidebarLink in <b>src/pages/_layout/topbar_with_navigation/sidebar_mobile/SidebarContent.js</b>

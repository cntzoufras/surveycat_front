...
const SurveyCreate = () => {
  ...
  const {
    ...
    todoElements: state.survey_create && state.survey_create.data && state.survey_create.data.elements
      && state.survey_create.data.elements.length > 0 ? [...state.survey_create.data.elements] : [],
    isFetching: state.survey_create && state.survey_create.isFetching,
    theme: state.theme,
